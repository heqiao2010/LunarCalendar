...
public class HkOTest {
     ...
     * 校验农历月份
     */
    private boolean validateLunarMonth(int year, String content){
     ...
     * 校验天干地支以及生肖
     */
    private boolean validateGanZhiAndAnimal(int year, String content) {
